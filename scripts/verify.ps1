...
$checks = @(
    ...
    @{ Name = "Desktop GUI Binary"; Path = Join-Path $binDir "agy_gui.py" },
    @{ Name = "Audit & PR Binary"; Path = Join-Path $binDir "agy_audit.py" },
    @{ Name = "Memory Binary"; Path = Join-Path $binDir "agy_memory.py" },
    @{ Name = "CLI Launcher (agy-gui)"; Path = Join-Path $binDir "agy-gui.bat" },
    ...
    @{ Name = "Universal Launcher (agent-gui)"; Path = Join-Path $binDir "agent-gui.bat" },
